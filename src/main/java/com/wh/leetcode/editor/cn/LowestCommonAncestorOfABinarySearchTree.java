...
class Solution {
    ...
    /**
     * 先遍历一遍树，得到深度和父母map
     * 首先将两个节点深度变成一致：更深的节点往上走，直到深度一致，然后两个节点一起往上走，直接父母相同
     */
    ...
    private void readTree(TreeNode node, HashMap<TreeNode,Integer> depthMap , HashMap<TreeNode,TreeNode> parentMap){
